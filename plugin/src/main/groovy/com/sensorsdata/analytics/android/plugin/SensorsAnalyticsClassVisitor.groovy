    ...
    MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
        ...
        SensorsAnalyticsDefaultMethodVisitor sensorsAnalyticsDefaultMethodVisitor = new SensorsAnalyticsDefaultMethodVisitor(methodVisitor, access, name, desc) {
            ...
            protected void onMethodEnter() {
                if (mClassName.equals("com/baidu/location/b/k") && methodName.equals("d")) {
                    methodVisitor.visitLdcInsn("bobobobo")
                    Logger.error("EEENNNTTTEEERRR")
                    methodVisitor.visitLdcInsn("123456")
